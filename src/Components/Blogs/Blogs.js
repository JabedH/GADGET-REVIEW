    ...
    <div className="grid grid-cols-3 gap-10 m-10 text-justify mt-20">
      <div className="bg-slate-50 p-5 rounded-lg drop-shadow-lg">
        <p>
          ...
          if we want to access data globally we can't. So For this react
          introduced Context API. The React Context API is a way for a React app
          to effectively produce global variables that can be passed around.
          This is the alternative to "props drilling". React.createContext() is
          all you need. It returns a consumer and a provider. The provider is a
          component that holds the "store" value. The consumer is a component
      ...
      <div className="bg-slate-50 p-5 rounded-lg drop-shadow-lg">
        <p>
          ...
          of inline and block element. inline-block element slow left and right
          top bottom margins and padding. we can set width and height.
        </p>
      </div>
    </div>
  );
